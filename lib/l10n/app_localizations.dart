...
abstract class AppLocalizations {
  ...
  /// No description provided for @workshopReviews.
  ///
  /// In en, this message translates to:
  /// **'Workshop Reviews'**
  String get workshopReviews;

  /// No description provided for @compareWorkshops.
  ///
  /// In en, this message translates to:
  /// **'Compare Workshops'**
  String get compareWorkshops;
  ...
  /// No description provided for @langArShort.
  ///
  /// In en, this message translates to:
  /// **'AR'**
  String get langArShort;
}
